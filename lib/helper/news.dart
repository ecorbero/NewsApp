...
class News {
  ...
  Future<void> getNews() async {
    String url =
        "http://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=b6dcd3276ea44e26be67b6e0e61a9a36";
...
class CategoryNewsClass {
  ...
  Future<void> getNews(String category) async {
    String url =
        "http://newsapi.org/v2/top-headlines?country=us&category=$category&apiKey=b6dcd3276ea44e26be67b6e0e61a9a36";
